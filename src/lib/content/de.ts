...
export const content = {
  ...
  market: {
    ...
    kpisGrid: [
      {
        value: "215.289",
        label: "Baugenehmigungen 2024",
        sub: "Tiefster Stand seit 2010",
        accent: "dark" as const,
      },
      {
        value: "206.586",
        label: "Fertigstellungen 2025",
        sub: "−18 % — niedrigster Wert seit 2012",
        accent: "accent" as const,
      },
      {
        value: "52 %",
        label: "Vom Bundesziel",
        sub: "400.000 Wohnungen/Jahr — Wohnungsmangel wächst",
        accent: "dark" as const,
      },
      {
        value: "41,9 %",
        label: "Wohneigentumsquote",
        sub: "Niedrigste in der EU — 58 % zur Miete",
        accent: "accent" as const,
      },
    ],
    conclusions: [
      {
        ...
        text: "+64 % Baukosten, 27 Monate von Genehmigung bis Fertigstellung",
        highlight: false,
      },
      {
        tag: "PROBLEM 02",
        title: "Unterversorgung",
        text: "Baugenehmigungs-Einbruch bei akutem Wohnungsmangel",
        highlight: false,
      },
      {
        tag: "LÖSUNG",
        title: "Modulares Bauen",
        text: "Schneller, kosteneffizienter, planbar — Made in Germany",
        highlight: true,
      },
    ],
  },
